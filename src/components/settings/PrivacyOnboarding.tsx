...
export function PrivacyOnboarding({ onDismiss }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 px-4 pb-6 pt-10">
      <div className="bg-white rounded-3xl w-full max-w-[480px] px-6 py-7 space-y-4">
        <div className="text-[40px] leading-none">🐰</div>
        <h1 className="text-[22px] font-extrabold text-[#132825]">Welcome to Route Rabbit</h1>
        <p className="text-[15px] text-[#3a4c49] leading-relaxed">
